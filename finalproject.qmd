...
Note: We decided to leave in danceability and mechanism because we felt that these variables are easily understandable from an interpretable standpoint of the model.
...
LASSO kept all of the predictors, demonstrating that the predictor variables are meaningfully contributing to our outcome of interest of whether the song is on a major/minor scale.
